sap.ui.define([
    ...
    return BaseObject.extend("ccb.org.certingresosret.service.BackendService", {
        ...
        _getAppBase: function () {
            return sap.ui.require.toUrl("ccb/org/certingresosret");
        },

        /**
         * Consulta los datos básicos del empleado por su correo electrónico
